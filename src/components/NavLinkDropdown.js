...
export default function NavLinkDropdown() {
    ...
    <div className="w-100 d-none d-md-block d-lg-none d-sm-block d-md-none d-block d-sm-none">
        <div className="collapse navbar-collapse" id="navbarCollapse">
            <ul style={{lineHeight: "30px"}} className="list-unstyled pl-2">
                <li><a className="text-white" href="#"><i style={{width: "30px", display: "inline-block"}}
                                                          className="icon-surface1-12 pr-2"/>Tuin</a></li>
                <li><a className="text-white" href="#"><i style={{width: "30px", display: "inline-block"}}
                                                          className="icon-surface1-11 pr-2"/>Gereedschap</a></li>
                <li><a className="text-white" href="#"><i style={{width: "30px", display: "inline-block"}}
                                                          className="icon-surface1-11 pr-2"/>Bouwmaterialen</a></li>
                <li><a className="text-white" href="#"><i style={{width: "30px", display: "inline-block"}}
                                                          className="icon-Varlk-11 pr-2"/>Hout & schrijnwerk</a></li>
                <li><a className="text-white" href="#"><i style={{width: "30px", display: "inline-block"}}
                                                          className="icon-Varlk-9 pr-2"/>Verf & houtbescherming</a>
                </li>
                <li><a className="text-white" href="#"><i style={{width: "30px", display: "inline-block"}}
                                                          className="icon-surface1-7 pr-2"/>Sanitair</a></li>
                <li><a className="text-white" href="#"><i style={{width: "30px", display: "inline-block"}}
                                                          className="icon-surface1-2 pr-2"/>Verlichting</a></li>
                <li><a className="text-white" href="#"><i style={{width: "30px", display: "inline-block"}}
                                                          className="icon-surface1-6 pr-2"/>Ijzerwaren</a></li>
                <li><a className="text-white" href="#"><i style={{width: "30px", display: "inline-block"}}
                                                          className="icon-surface1 pr-2"/>Elektriciteit</a></li>
                <li><a className="text-white" href="#"><i style={{width: "30px", display: "inline-block"}}
                                                          className="icon-surface1-3 pr-2"/>Verwarming</a></li>
                <li><a className="text-white" href="#"><i style={{width: "30px", display: "inline-block"}}
                                                          className="icon-surface1-5 pr-2"/>Huishouden</a></li>
                <li><a className="text-white" href="#"><i style={{width: "30px", display: "inline-block"}}
                                                          className="icon-Varlk-18 pr-2"/>Behang & decoratie</a></li>
                <li><a className="text-white" href="#"><i style={{width: "30px", display: "inline-block"}}
                                                          className="icon-surface1-9 pr-2"/>Auto & fiets</a></li>
                <li><a className="text-white" href="#"><i style={{width: "30px", display: "inline-block"}}
                                                          className="icon-surface1-8 pr-2"/>Keuken</a></li>
                <li><a className="text-white" href="#"><i style={{width: "30px", display: "inline-block"}}
                                                          className="icon-surface1-10 pr-2"/>Dierenverzorging</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <NavbarCollapse className="collapse navbar-collapse d-none d-lg-block d-xl-none" id="navbarCollapse">
        <Nav className="navbar-nav w-100 justify-content-between ml-5">
            <NavDropdown.Item className="nav-item align-self-center dropdown-hoverable">
                <Nav.Link className="custom-nav nav-link rounded-0 text-left px-3 text-uppercase font-weight-bold"
                   href="#" role="button" data-toggle="dropdown" aria-haspopup="true"
                   aria-expanded="false">
                    <i style={{fontSize: "10px"}} className="icon-surface1-38 pr-2"/>Aan De Slag
                </Nav.Link>
                    ...
                    <DropdownMenu className="border-0 pt-0 mt-0 w-100">
                        <ul style={{lineHeight: "30px"}} className="list-unstyled p-4">
                            <li><a className="text-dark" href="#"><i style={{width: "30px", display: "inline-block"}}
                                                                     className="icon-surface1-12 pr-2"/>Tuin</a></li>
                            <li><a className="text-dark" href="#"><i style={{width: "30px", display: "inline-block"}}
                                                                     className="icon-surface1-11 pr-2"/>Gereedschap</a>
                            </li>
                            <li><a className="text-dark" href="#"><i style={{width: "30px", display: "inline-block"}}
                                                                     className="icon-surface1-11 pr-2"/>Bouwmaterialen</a>
                            </li>
                            <li><a className="text-dark" href="#"><i style={{width: "30px", display: "inline-block"}}
                                                                     className="icon-Varlk-11 pr-2"/>Hout &
                                schrijnwerk</a></li>
                            <li><a className="text-dark" href="#"><i style={{width: "30px", display: "inline-block"}}
                                                                     className="icon-Varlk-9 pr-2"/>Verf &
                                houtbescherming</a></li>
                            <li><a className="text-dark" href="#"><i style={{width: "30px", display: "inline-block"}}
                                                                     className="icon-surface1-7 pr-2"/>Sanitair</a>
                            </li>
                            <li><a className="text-dark" href="#"><i style={{width: "30px", display: "inline-block"}}
                                                                     className="icon-surface1-2 pr-2"/>Verlichting</a>
                            </li>
                            <li><a className="text-dark" href="#"><i style={{width: "30px", display: "inline-block"}}
                                                                     className="icon-surface1-6 pr-2"/>Ijzerwaren</a>
                            </li>
                            <li><a className="text-dark" href="#"><i style={{width: "30px", display: "inline-block"}}
                                                                     className="icon-surface1 pr-2"/>Elektriciteit</a>
                            </li>
                            <li><a className="text-dark" href="#"><i style={{width: "30px", display: "inline-block"}}
                                                                     className="icon-surface1-3 pr-2"/>Verwarming</a>
                            </li>
                            <li><a className="text-dark" href="#"><i style={{width: "30px", display: "inline-block"}}
                                                                     className="icon-surface1-5 pr-2"/>Huishouden</a>
                            </li>
                            <li><a className="text-dark" href="#"><i style={{width: "30px", display: "inline-block"}}
                                                                     className="icon-Varlk-18 pr-2"/>Behang &
                                decoratie</a></li>
                            <li><a className="text-dark" href="#"><i style={{width: "30px", display: "inline-block"}}
                                                                     className="icon-surface1-9 pr-2"/>Auto &
                                fiets</a></li>
                            <li><a className="text-dark" href="#"><i style={{width: "30px", display: "inline-block"}}
                                                                     className="icon-surface1-8 pr-2"/>Keuken</a>
                            </li>
                            <li><a className="text-dark" href="#"><i style={{width: "30px", display: "inline-block"}}
                                                                     className="icon-surface1-10 pr-2"/>Dierenverzorging</a>
                            </li>
                                ...
                                <Col sm={5} md={3} className="my-nav-pills">
                                    <ul style={{lineHeight: "14px"}}
                                        ...
                                        <li><a className="nav-link" href="#hout" role="tab" data-toggle="tab"><i
                                            style={{width: "30px", display: "inline-block"}}
                                            className="icon-Varlk-11 pr-2"/>Hout & schrijnwerk</a>
                                        </li>
                                        ...
                                        <li><a className="nav-link" href="#behang" role="tab"
                                               data-toggle="tab"><i
                                            style={{width: "30px", display: "inline-block"}}
                                            className="icon-Varlk-18 pr-2"/>Behang & decoratie</a>
                                        </li>
                                            ...
                                            <Row>
                                                <Col sm={12} md={5}>
                                                    <ul style={{lineHeight: "28px"}} className="list-unstyled">
                                                        <li>
                                                            <h4 className="font-weight-bold">Tuinconstructies &
                                                                opberging</h4>
                                                        </li>
                                                    ...
                                                    <ul style={{lineHeight: "28px"}}
                                                        ...
                                                        <li>
                                                            <h4 className="font-weight-bold">Tuindraad</h4>
                                                        </li>
                                                ...
                                                <Col sm={12} md={5}>
                                                    <ul style={{lineHeight: "28px"}} className="list-unstyled">
                                                        <li>
                                                            <h4 className="font-weight-bold">Tuingereedschap &
                                                                machines</h4>
                                                        </li>
                                                    ...
                                                    <ul style={{lineHeight: "28px"}}
                                                        className="list-unstyled mt-5">
                                                        <li>
                                                            <h4 className="font-weight-bold">Partytenten &
                                                                zonnetenten</h4>
                                                        </li>
