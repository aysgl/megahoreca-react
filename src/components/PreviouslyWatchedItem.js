...
export default function PreviouslyWatchedItem() {
    return <div>
        <a className="item">
            ...
            <div className="p-3 text-left">
                <small className="fw-bold mb-0">Apple iPad(2018) 32GB</small>
                <h5 className="fw-bold mb-0"><span>€499,</span><span className="h6">99</span></h5>
            </div>
        </a>
    </div>
}