            ...
            <Row>
                            ...
                            <Col className="d-flex align-content-between flex-wrap text-left">
                                <Card.Body>
                                    <p className="text-black-30 mb-1"><small><i style={{ fontSize: "9px" }}
                                        className="icon-surface1-44 pe-2" />Computers
                                        & Tablets</small></p>
                                    ...
                                    <p className="text-secondary"><small><i
                                        className="icon-surface1-51 text-primary" /><i
                                            ...
                                            className="icon-surface1-51 text-primary" /><i
                                            className="icon-surface1-51 text-primary" /><i
                                            className="icon-surface1-51 text-primary pe-2" />2324</small></p>

                                    <a className="btn-arrow fw-bold">100 Dagen op proef</a>

                                </Card.Body>
                                <Card.Footer className="mb-0">
                                    <h3 className="fw-bold"><span>€499,</span><span className="h6">99</span>
                                    </h3>
                                    <a className="text-black-30" href="#"><i
                                        className="icon-surface1-41 pe-3" /></a><a
                ...
                <Col sm={3} className="d-flex align-self-stretch pr-0">
                    <div className="shadow rounded d-flex align-content-between flex-wrap text-left">
                        <Card.Body>
                            <p className="text-black-30 mb-1"><small><i style={{ fontSize: "9px" }}
                                className="icon-surface1-44 pe-2" />Reizen &
                                Fashion</small></p>
                            ...
                            <p className="text-secondary mb-0"><small><i
                                className="icon-surface1-51 text-primary" /><i
                                    ...
                                    className="icon-surface1-51 text-primary" /><i
                                    className="icon-surface1-51 text-primary" /><i
                                    className="icon-surface1-52 text-primary pe-2" />532</small></p>
                        </Card.Body>
                        <img className="img-fluid ps-4" src={product7} alt="Apple iPad 2018 32GB" />
                        <Card.Footer className="w-100">
                            <Row>
                                <Col>
                                    <h3 className="fw-bold"><span>€499,</span><span
                                        className="h6">99</span></h3>
                                </Col>
                                <Col className="pt-2 text-right">
                                    <a className="text-black-30" href="#"><i className="icon-surface1-41 pe-3" /></a><a
                                        className="text-black-30" href="#"><i className="icon-surface1-36"
                                            style={{ fontSize: "20px" }} /></a>
                                </Col>
                            </Row>
                        ...
                        <ul className="list-unstyled h-100">
                            <li className="shadow rounded h-50">
                                <div className="h-100 d-flex align-content-between flex-wrap text-left">
                                    <Card.Body>
                                        <p className="text-black-30 mb-1"><small><i style={{ fontSize: "9px" }}
                                            className="icon-surface1-44 pe-2" />Huishouden
                                            & Wonen</small></p>
                                        ...
                                        <p className="text-secondary"><small><i
                                            className="icon-surface1-51 text-primary" /><i
                                                ...
                                                className="icon-surface1-51 text-primary" /><i
                                                className="icon-surface1-51 text-primary" /><i
                                                className="icon-surface1-51 text-primary pe-2" />432</small></p>
                                    </Card.Body>
                                    ...
                                    <img style={{ position: "absolute", right: "0px", height: "200px", top: "20px" }}
                                        className="img-fluid pe-3" src={product8} alt="Apple iPad 2018 32GB" />
                                </div>
                            </li>
                            <li className="shadow rounded h-50">
                                <div className="h-100 d-flex align-content-between flex-wrap text-left">
                                    ...
                                    <div style={{ position: "absolute", right: "0", bottom: "0px" }} className="pe-3">
